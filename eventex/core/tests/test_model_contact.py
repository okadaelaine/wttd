...
class ContactModelTest(TestCase):
    ...
    def test_phone(self):
        contact = Contact.objects.create(speaker=self.speaker, kind=Contact.PHONE, value='12-123451234')
...
class ContactManagerTest(TestCase):
    def setUp(self):
        ...
        s.contact_set.create(kind=Contact.PHONE, value='12123451234')
